...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/tmatin100/PGDO-DevOps-FinalProject-.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-tmatin-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-tmatin-service.yml;
                ```
Save and run the job.
